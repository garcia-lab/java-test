  ...
  stages {
    stage('Checkout') {
      steps {
        ...
        checkout([$class: 'Default', branches: [[name: '*/main']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[url: 'git@ghe.io:colossus9-test-org/java-test.git']]])
